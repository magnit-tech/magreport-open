...
class DataSetFolderTest extends BaseEntityTest {
    ...
    void testNoArgsConstructor() {
        ...
        assertNotNull(folder.getDataSets());
        assertNotNull(folder.getFolderRoles());

        var testFolder = new DataSetFolder(-ID);
        assertEquals(-ID, testFolder.getId());
    }

    private static DataSetFolder getFolder() {
        return new DataSetFolder()
                ...
                .setParentFolder(new DataSetFolder())
