...
class ScheduleTypeTest extends BaseEntityTest {
    ...
    @Test
    void testIdArgs() {
        var response = new ScheduleType(ID);
        assertEquals(ID, response.getId());
    }

    @Test
    void testEquals () {
        var item1 = getScheduleType();
        var item2 = getScheduleType();
