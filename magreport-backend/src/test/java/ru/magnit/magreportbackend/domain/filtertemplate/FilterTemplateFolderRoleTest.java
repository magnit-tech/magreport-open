...
class FilterTemplateFolderRoleTest extends BaseEntityTest {
    ...
    void testNoArgsConstructor() {
        var field = getFilterTemplateFolderRole();
        ...
        var testField = new FilterTemplateFolderRole(-ID);
        assertEquals(-ID, testField.getId());
    }

    private static FilterTemplateFolderRole getFilterTemplateFolderRole() {
        return new FilterTemplateFolderRole()
                .setId(ID)
                .setRole(new Role(ROLE_ID))
                .setFolder(new FilterTemplateFolder(FOLDER_ID))
