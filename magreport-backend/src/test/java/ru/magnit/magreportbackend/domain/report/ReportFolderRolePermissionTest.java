...
class ReportFolderRolePermissionTest extends BaseEntityTest {
    ...
    void testNoArgsConstructor() {
        var field = getReportFolderRolePermission();
        ...
        var testField = new ReportFolderRolePermission(-ID);
        assertEquals(-ID, testField.getId());
    }

    private static ReportFolderRolePermission getReportFolderRolePermission() {
        return new ReportFolderRolePermission()
                .setId(ID)
                .setFolderRole(new ReportFolderRole(FOLDER_ROLE_ID))
