...
class SecurityFilterFolderRoleTest extends BaseEntityTest {
    ...
    void testNoArgsConstructor() {
        var field = getSecurityFilterFolderRole();
        ...
        var testField = new SecurityFilterFolderRole(-ID);
        assertEquals(-ID, testField.getId());
    }

    private static SecurityFilterFolderRole getSecurityFilterFolderRole() {
        return new SecurityFilterFolderRole()
                .setId(ID)
                .setRole(new Role(ROLE_ID))
                .setFolder(new SecurityFilterFolder(FOLDER_ID))
