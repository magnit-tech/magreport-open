...
class ExcelTemplateFolderRoleTest extends BaseEntityTest {
    ...
    void testNoArgsConstructor() {
        var field = getExcelTemplateFolderRole();
        ...
        var testField = new ExcelTemplateFolderRole(-ID);
        assertEquals(-ID, testField.getId());
    }

    private static ExcelTemplateFolderRole getExcelTemplateFolderRole() {
        return new ExcelTemplateFolderRole()
                .setId(ID)
                .setRole(new Role(ROLE_ID))
                .setFolder(new ExcelTemplateFolder(FOLDER_ID))
