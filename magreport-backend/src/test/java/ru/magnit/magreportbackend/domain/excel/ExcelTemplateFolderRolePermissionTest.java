...
class ExcelTemplateFolderRolePermissionTest extends BaseEntityTest {
    ...
    void testNoArgsConstructor() {
        var field = getExcelTemplateFolderRolePermission();
        ...
        var testField = new ExcelTemplateFolderRolePermission(-ID);
        assertEquals(-ID, testField.getId());
    }

    private static ExcelTemplateFolderRolePermission getExcelTemplateFolderRolePermission() {
        return new ExcelTemplateFolderRolePermission()
                .setId(ID)
                .setFolderRole(new ExcelTemplateFolderRole(FOLDER_ROLE_ID))
