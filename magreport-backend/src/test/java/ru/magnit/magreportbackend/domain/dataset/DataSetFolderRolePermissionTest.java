...
class DataSetFolderRolePermissionTest extends BaseEntityTest {
    ...
    void testNoArgsConstructor() {
        var field = getDataSetFolderRolePermission();
        ...
        var testField = new DataSetFolderRolePermission(-ID);
        assertEquals(-ID, testField.getId());
    }

    private static DataSetFolderRolePermission getDataSetFolderRolePermission() {
        return new DataSetFolderRolePermission()
                .setId(ID)
                .setFolderRole(new DataSetFolderRole(FOLDER_ROLE_ID))
