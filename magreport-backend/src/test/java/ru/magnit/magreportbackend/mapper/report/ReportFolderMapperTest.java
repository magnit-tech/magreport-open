...
class ReportFolderMapperTest {
    ...
    @InjectMocks
    private ReportFolderMapper mapper;

    @Test
    void from() {
        ReportFolder folder = mapper.from(getRequest());
        ...
        List<ReportFolder> folders = mapper.from(Collections.singletonList(getRequest()));
