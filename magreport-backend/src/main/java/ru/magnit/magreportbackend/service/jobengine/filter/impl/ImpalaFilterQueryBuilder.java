...
public class ImpalaFilterQueryBuilder  implements FilterQueryBuilder {

    private final TemplateParserService templateParserService;

    @Value("${magreport.query-templates.filter.value-list.impala}")
    private String valueListTemplatePath;

    @Value("${magreport.query-templates.filter.child-nodes.impala}")
    private String childNodesTemplatePath;

    @Value("${magreport.query-templates.filter.fields.impala}")
